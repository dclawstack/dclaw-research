...
**DClaw Research** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8064` (FastAPI)
- **Frontend Port:** `3064` (Next.js)
- **Database:** `dclaw_research` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3064`
